...
public class BlogController {
    ...
    @GetMapping("/blog/add")
    public String blogAdd(Model model) { return "blog_add"; }
    ...
    public String blogPostAdd(@PathVariable(value = "id") long id, @RequestParam String title, @RequestParam String anons, @RequestParam String fullText, Model model) {
